...
namespace ISO8601.Tests
{
    ...
    public class DesignatedDurationTests
    {
        ...
        public void CanRoundTrip()
        {
            ...
            Assert.AreEqual("P5Y5M5DT5H5.55S", DesignatedDuration.Parse("P5Y5M5DT5H5.55S").ToString(new ISO8601Options { FractionLength = 2, DecimalSeparator = '.' }));
            Assert.AreEqual("P5Y5M5DT5,55S", DesignatedDuration.Parse("P5Y5M5D5,55S").ToString());
            Assert.AreEqual("P5Y5MT5.55S", DesignatedDuration.Parse("P5Y5MT5.55S").ToString(new ISO8601Options { FractionLength = 2, DecimalSeparator = '.' }));
            Assert.AreEqual("P5YT5,55S", DesignatedDuration.Parse("P5YT5,55S").ToString());
            Assert.AreEqual("PT5.55S", DesignatedDuration.Parse("PT5.55S").ToString(new ISO8601Options { FractionLength = 2, DecimalSeparator = '.' }));
            Assert.AreEqual("P5M5DT5H5M5,55S", DesignatedDuration.Parse("P5M5DT5H5M5,55S").ToString());
            Assert.AreEqual("P5M5DT5H5.55S", DesignatedDuration.Parse("P5M5DT5H5.55S").ToString(new ISO8601Options { FractionLength = 2, DecimalSeparator = '.' }));
            Assert.AreEqual("P5M5DT5,55S", DesignatedDuration.Parse("P5M5DT5,55S").ToString());
            Assert.AreEqual("P5MT5.55S", DesignatedDuration.Parse("P5MT5.55S").ToString(new ISO8601Options { FractionLength = 2, DecimalSeparator = '.' }));
            Assert.AreEqual("P5DT5H5M5,55S", DesignatedDuration.Parse("P5DT5H5M5,55S").ToString());
            Assert.AreEqual("P5DT5H5.55S", DesignatedDuration.Parse("P5DT5H5.55S").ToString(new ISO8601Options { FractionLength = 2, DecimalSeparator = '.' }));
            ...
            Assert.AreEqual("PT5H5.55S", DesignatedDuration.Parse("PT5H5.55S").ToString(new ISO8601Options { FractionLength = 2, DecimalSeparator = '.' }));
