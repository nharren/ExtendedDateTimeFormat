...
namespace System.ISO8601
{
    public class DurationTimeInterval : TimeInterval
    {
        ...
        {
            _duration = new DesignatedStandardDuration(years, months, days, hours, minutes, seconds);
        }

        public DurationTimeInterval(int years, int months, int days, int hours, double minutes)
        {
            _duration = new DesignatedStandardDuration(years, months, days, hours, minutes);
        }

        public DurationTimeInterval(int years, int months, int days, double hours)
        {
            _duration = new DesignatedStandardDuration(years, months, days, hours);
        }

        public DurationTimeInterval(int years, int months, double days)
        {
            _duration = new DesignatedStandardDuration(years, months, days);
        }

        public DurationTimeInterval(int years, double months)
        {
            _duration = new DesignatedStandardDuration(years, months);
        }

        public DurationTimeInterval(double years)
        {
            _duration = new DesignatedStandardDuration(years);
        }
        ...
        {
            return new DurationTimeInterval(new DesignatedWeekDuration(weeks));
        }
    }
}