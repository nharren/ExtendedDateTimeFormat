...
namespace Tests
{
    public static class CalculationTestEntries
    {
        public static CalculationTestEntry[] Difference =
        {
            ...
            new CalculationTestEntry("2012-11-20T20Z - 2012-02-02T02Z", () => (new ExtendedDateTime(2012, 11, 20, 20, TimeSpan.Zero) - new ExtendedDateTime(2012, 2, 2, 2, TimeSpan.Zero)).ToString(), "292.18:00:00"),                                           // 20 additional hours passed after the end day - 2 hours in to the beginning day = 18 additional hours
            ...
            new CalculationTestEntry("2012-11-20T20:20Z - 2012-02-02T02:02Z", () => (new ExtendedDateTime(2012, 11, 20, 20, 20, TimeSpan.Zero) - new ExtendedDateTime(2012, 2, 2, 2, 2, TimeSpan.Zero)).ToString(), "292.18:18:00"),                              // 20 additional minutes passed after the end hour - 2 minutes in to the beginning hour = 18 additional minutes
            ...
            new CalculationTestEntry("2012-11-20T20:20:20Z - 2012-02-02T02:02:02Z", () => (new ExtendedDateTime(2012, 11, 20, 20, 20, 20, TimeSpan.Zero) - new ExtendedDateTime(2012, 2, 2, 2, 2, 2, TimeSpan.Zero)).ToString(), "292.18:18:18"),                 // 20 additional seconds passed after the end minute - 2 seconds in to the beginning minute = 18 additional seconds
